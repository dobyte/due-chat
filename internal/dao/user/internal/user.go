...
import (
	...
	"errors"
	"fmt"
	modelpkg "github.com/dobyte/due-chat/internal/model"
	"gorm.io/gorm"
	"strconv"
	"strings"
)
...
var userColumns = &Columns{
	...
	LastLoginAt: "last_login_at", // 最新登录时间
	LastLoginIP: "last_login_ip", // 最新登录IP
}
...
func (dao *User) Update(ctx context.Context, filterFunc FilterFunc, updateFunc UpdateFunc, columnFunc ...ColumnFunc) (int64, error) {
	db := dao.Table.WithContext(ctx)
